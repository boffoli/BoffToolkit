...
namespace BoffToolkit.Configuration.JsonSettings
{
    ...
    public class JsonSettingsBuilder
    {
        ...
        private string ReadJsonContentFromFile(string filePath)
        {
        ...
        private string ReadJsonContentFromResource(Assembly assembly, string resourceName)
        {
        ...
        private string ReadSchemaFromFile(string schemaFilePath)
        {
        ...
        private string ReadSchemaFromResource(string resourceSchemaName, Assembly? schemaAssembly)
        {
        ...
        private void ValidateJson(string jsonContent, string schemaContent = "")
        {
            if (!string.IsNullOrEmpty(schemaContent))
            {

    ...
    public class JobSchedulerBuilder {
        ...
        private sealed class BuilderSteps : IStartTimeSetter, IPeriodSetter, ICallbackSetter, IBackgroundSetting, IBuildable {
            ...
            public IBackgroundSetting SetCallback(Action callback) {
                _builder._callbackAdapter = CallbackAdapter<object, object>.Create(callback ?? throw new ArgumentNullException(nameof(callback), "Il callback non può essere null."));
                return this;
            }

            /// <inheritdoc/>
            public IBackgroundSetting SetCallback<TParam>(Action<TParam> callback, TParam param) {
                if (callback == null) throw new ArgumentNullException(nameof(callback), "Il callback non può essere null.");
                if (param == null) throw new ArgumentNullException(nameof(param), "Il parametro non può essere null.");
            ...
            public IBackgroundSetting SetCallback<TResult>(Func<TResult> func) {
                _builder._callbackAdapter = CallbackAdapter<TResult, object>.Create(func ?? throw new ArgumentNullException(nameof(func), "La funzione di callback non può essere null."));
                return this;
            }

            /// <inheritdoc/>
            public IBackgroundSetting SetCallback<TParam, TResult>(Func<TParam, TResult> func, TParam param) {
                if (func == null) throw new ArgumentNullException(nameof(func), "La funzione di callback non può essere null.");
                if (param == null) throw new ArgumentNullException(nameof(param), "Il parametro non può essere null.");
            ...
            public IBackgroundSetting SetCallback<TResult>(ISchedulable<TResult> schedulable) {
                _builder._callbackAdapter = CallbackAdapter<TResult, object>.Create(schedulable ?? throw new ArgumentNullException(nameof(schedulable), "Il schedulable non può essere null."));
                return this;
            }

            /// <inheritdoc/>
            public IBackgroundSetting SetCallback<TParam, TResult>(ISchedulable<TParam, TResult> schedulable, TParam param) {
                if (schedulable == null) throw new ArgumentNullException(nameof(schedulable), "Il schedulable non può essere null.");
                if (param == null) throw new ArgumentNullException(nameof(param), "Il parametro non può essere null.");
            ...
            public IBuildable SetCallbackCompleted(EventHandler<CallbackCompletedEventArgs> handler) {
                _builder._onCallbackCompleted = handler ?? throw new ArgumentNullException(nameof(handler), "Il gestore dell'evento non può essere null.");
                return this;
            }
